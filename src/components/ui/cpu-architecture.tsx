...
const CpuArchitecture = ({
  ...
  return (
    <svg
      className={cn(
        "text-white/90 drop-shadow-[0_0_40px_rgba(255,255,255,0.35)]",
        className,
      )}
      width={width}
      height={height}
    ...
    >
      ...
      <g>
        ...
        {showCpuConnections && (
          <g fill="url(#cpu-connection-gradient)">
            <rect x="92" y="39" width="2.5" height="5" rx="0.7" />
            <rect x="108" y="39" width="2.5" height="5" rx="0.7" />
            <rect
              x="118.3"
              y="46"
              width="2.5"
              height="5"
              rx="0.7"
              transform="rotate(90 118.3 48.5)"
            />
            <rect
              x="124.8"
              y="46"
            ...
            <rect
              ...
              height="5"
              rx="0.7"
              transform="rotate(180 109.25 41.5)"
            />
            <rect
              x="118.5"
              y="18"
            ...
            <rect
              ...
              height="5"
              rx="0.7"
              transform="rotate(270 117.25 21.5)"
            />
            <rect
              x="89"
              y="-13.6"
        ...
        <text
          ...
          y="52"
          fontSize="6.4"
          fill={animateText ? "url(#cpu-text-gradient)" : "#0f172a"}
          fontWeight="700"
      ...
      <defs>
        ...
        <radialGradient id="cpu-orange-grad" fx="1">
          <stop offset="0%" stopColor="#fda172" />
          <stop offset="100%" stopColor="transparent" />
        </radialGradient>
        ...
        <linearGradient id="cpu-chip-gradient" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#ffffff" stopOpacity="0.95" />
          <stop offset="55%" stopColor="#f4f6ff" stopOpacity="0.88" />
          <stop offset="100%" stopColor="#eef2ff" stopOpacity="0.82" />
        </linearGradient>
